...
function firstNonConsecutive(arr){
    ...
    for (let i of arr){
        if(cons_counter ==  i){
            ...
            console.log(cons_counter-1);
            break;
        };
           
    }
    if (cons_counter - arr.length == 1){
        console.log(-1);
    };
...
// function sumPositive(a_list) {
//     sum = 0
//     for (let num of a_list){
//         if (num > 0){
//             sum = sum + num;
//         };
//     };
